            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  ...
                  text={
                    data?.interview_date
                      ? format(parseISO(data?.interview_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Interview Time" text={data?.interview_time} />

                <FormListItem label="Interview Type" text={data?.interview_type} />

                <FormListItem label="Interview Status" text={data?.interview_status} />
                ...
                {hasAccess('candidate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Candidate"
                    text={
                      <Link as={NextLink} href={`/candidates/view/${data?.candidate?.id}`}>
