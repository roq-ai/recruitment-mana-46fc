...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Project Assignment.create': {
    roles: ['project-manager', 'director', 'technical-assessor'],
    key: 'project_assignment',
    tenantPath: [],
    userPath: [],
  },
  'Performance Review.update': {
    roles: ['hr-manager', 'hr-team-member'],
    key: 'performance_review',
    tenantPath: [],
    userPath: [],
  },
  'Policy Update.update': {
    roles: ['hr-manager', 'hr-team-member', 'project-manager', 'director', 'technical-assessor'],
    key: 'policy_update',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['hr-manager', 'hr-team-member', 'project-manager', 'director', 'technical-assessor'];
